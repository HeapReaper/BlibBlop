...
export default class Tasks {
	...
	async disboardReview() {
		const embed = new EmbedBuilder()
			...
			.setDescription('Heb jij al een review achtergelaten op [Disboard](https://disboard.org/nl/server/1350811442856726559) of [Top.GG](https://top.gg/discord/servers/744654584256151552?s=01e8761801f01)?\nJe helpt de server daarmee groeien!')
